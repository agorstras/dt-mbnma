...
transformed parameters {
  ...
  r_1_emaxT_1 = r_1[, 1];
  r_1_kT_2 = r_1[, 2];
  lprior += normal_lpdf(b_emaxT[1] | -2.5, 10);
  lprior += normal_lpdf(b_emaxT[2] | -2.5, 10);
  lprior += normal_lpdf(b_emaxT[3] | -2.5, 10);
  lprior += normal_lpdf(b_emaxT[4] | -2.5, 10);
  lprior += normal_lpdf(b_emaxT[5] | -2.5, 10);
  lprior += normal_lpdf(b_emaxT[6] | -2.5, 10);
  lprior += normal_lpdf(b_emaxT[7] | -2.5, 10);
  lprior += normal_lpdf(b_emaxT[8] | 0, 100);
  lprior += normal_lpdf(b_emaxT[9] | 0, 100);
  lprior += normal_lpdf(b_emaxT[10] | 0, 100);
  lprior += normal_lpdf(b_emaxT[11] | 0, 100);
  lprior += normal_lpdf(b_emaxT[12] | 0, 100);
  lprior += normal_lpdf(b_emaxT[13] | 0, 100);
  lprior += normal_lpdf(b_kT[1] | -2.5, 10);
  lprior += normal_lpdf(b_kT[2] | -2.5, 10);
  lprior += normal_lpdf(b_kT[3] | -2.5, 10);
  lprior += normal_lpdf(b_kT[4] | -2.5, 10);
  lprior += normal_lpdf(b_kT[5] | -2.5, 10);
  lprior += normal_lpdf(b_kT[6] | -2.5, 10);
  lprior += normal_lpdf(b_kT[7] | -2.5, 10);
  lprior += normal_lpdf(b_kT[8] | 0, 100);
  lprior += normal_lpdf(b_kT[9] | 0, 100);
  lprior += normal_lpdf(b_kT[10] | 0, 100);
  lprior += normal_lpdf(b_kT[11] | 0, 100);
  lprior += normal_lpdf(b_kT[12] | 0, 100);
  lprior += normal_lpdf(b_kT[13] | 0, 100);
